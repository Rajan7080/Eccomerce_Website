                    ...
                    <ul
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu border-0 p-3 rounded-0 shadow" aria-labelledby="pages">
                                <li><a href="{{route('api.website')}}" class="dropdown-item">About Us </a></li>
                                <li><a href="{{route('api.website')}}" class="dropdown-item">Shop </a></li>
                                <li><a href="{{route('api.website')}}" class="dropdown-item">Single Product </a></li>
                                <li><a href="{{route('api.website')}}" class="dropdown-item">Cart </a></li>
                                <li><a href="{{route('api.website')}}" class="dropdown-item">Checkout </a></li>
                                <li><a href="{{route('api.website')}}" class="dropdown-item">Blog </a></li>
                                <li><a href="{{route('api.website')}}" class="dropdown-item">Single Post </a></li>
                                <li><a href="{{route('api.website')}}" class="dropdown-item">Styles </a></li>
                                <li><a href="{{route('api.website')}}" class="dropdown-item">Contact </a></li>
                                <li><a href="{{route('api.website')}}" class="dropdown-item">Thank You </a></li>
                                <li><a href="{{route('api.website')}}" class="dropdown-item">My Account </a></li>
                                <li><a href="{{route('api.website')}}" class="dropdown-item">404 Error </a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <div class="container-lg">
            <div class="row">
                <div class="col-md-6 copyright">
                    <p class="text-center">© 2025 Eccomerce-Organic-foods. All rights reserved. Rajan Pal</p>
                </div>
            </div>
        </div>
    </div>
